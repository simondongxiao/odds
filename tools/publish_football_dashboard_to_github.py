...
def publish(push: bool = True) -> dict[str, object]:
    ...
    latest_outputs = [
        ...
        (ROOT / "reviews", "yesterday_settlement_*.md", PUBLISH_REPO / "reports" / "reviews"),
        (ROOT / "ledger", "bettable_event_stats_*.csv", PUBLISH_REPO / "ledger"),
        (ROOT / "ledger", "bettable_event_detail_*.csv", PUBLISH_REPO / "ledger"),
        (ROOT / "ledger", "yesterday_candidate_intent_summary_*.csv", PUBLISH_REPO / "ledger"),
        (ROOT / "ledger", "yesterday_candidate_intent_detail_*.csv", PUBLISH_REPO / "ledger"),
        (ROOT / "ledger", "yesterday_official_settlement_*.csv", PUBLISH_REPO / "ledger"),
    ...
    for name in ("references/asian-side-risk-v3.md", "references/v3-implementation-contract.md", "references/cup-rotation-gateway.md", "scripts/asian_risk_v3.py", "scripts/test_asian_risk_v3.py", "scripts/cup_rotation_gateway.py", "scripts/test_cup_rotation_gateway.py"):
