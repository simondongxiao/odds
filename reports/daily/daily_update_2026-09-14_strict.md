...
- 当前 V3 名册纳入：12 场（亚冠/亚运会足球）；可投或半仓：0 场；其余按同一 V3 漏斗显示为不投或缺口。
- 当前 V4 Shadow 纳入：12 场；按独立赛事范围参与 posterior、EV、A/B/C/N 或 Missing 统计。
- 赛事归属：亚冠精英、亚冠2及其别名独立归类；亚运会足球独立归类；不并入欧洲非五大或亚洲泛残差，也不借用其他赛事的反抽/风控结论。
...
- 亚冠/亚运会足球已进入当天可投/不投漏斗及后续赛果反抽范围：通过。
- 历史方向漂移：未发生。
